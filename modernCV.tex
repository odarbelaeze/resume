...
\begin{centering}
    ...
    additional suppor documents if some are missing.
\end{centering}
...
\cventry{May. 2015\\--Jul. 2015}
        ...
        {%
            ...
            aproval \url{https://github.com/richard-evans/vampire/pull/4}
        }
...
\cventry{May. 2015\\--Jul. 2015}
        ...
        {%
            ...
            accross the world. Therefore, I had to learn how to communicate
...
\cvcomputer{Programming}   {C/C++\\FORTRAN\\Java\\Python\\JavaScript\\PHP}
           {Automation}    {Autotools\\Dist Utils\\Unittest\\Gulp\\CMake}

\cvcomputer{Scientific}    {Octave\\SciDavis\\GnuPlot\\scipy stack}
           {Typography}    {\LaTeX{}\\\LyX{}}


\cvcomputer{Web~design}    {HTML5\\CSS3\\sass}
