...
% '\\' adds a line break
\address{Apartment 43, Tibradden}{The Crescent, Two Oaks}

% optional
% \phone{+57(6) 890 6069}
% optional
\mobile{+353 83 207 8930}
% optional
%\fax{+43(0)999 7777}
% optional
\email{oscar@arbelaez.dev}
% optional
\extrainfo{%
...
\cventry{August 2024}
        ...
        {}
        {}
        {DOI:\@ \href{https://doi.org/10.5530/jscires.13.2.36}{10.5530/jscires.13.2.36}}
...
\cventry{August 2022}
        ...
        {}
        {}
        {DOI:\@ \href{https://doi.org/10.29173/istl2696}{10.29173/istl2696}}
...
\cventry{Feb 2022\\--current}
        {NextRoll Limited}
        {Staff Software Engineer}
        {Dublin, Ireland}
        {\href{https://nextroll.com}{nextroll.com}}
        {%
          Team lead and contributor to the Integrations pillar.
        }

\cventry{Oct. 2019\\--Jan. 2022}
        {NextRoll (via BairesDev)}
        {Full stack software engineer}
        {Remote}
        {\href{https://nextroll.com}{nextroll.com}}
        {%
          Developer of a web based applications for the company's social media
          marketing offerig and other external integrations. With a service based
          architecture these applications serve thousands of active advertisers.
        }


\cventry{Aug. 2019\\--Oct. 2019}
        {Engineering Contractor}
        {PlayVox}
        {Manizales, Colombia}
        {\href{https://playvox.com/}{playvox.com}}
        {%
          Architect and developer of a serverless based system that handles data
          synchronization from external APIs and provides an internal API to expose
          the processed data.
        }

\cventry{Apr. 2016\\--Feb. 2019}
        {Full stack software engineer}
        {BairesDev}
        {}
        {}
