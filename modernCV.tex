...
\cventry    {September 2014--\\current}
...
\cventry    {February 2013--\\current}
            {Scholarship holder}
            {Universidad Nacional de Colombia}
            {}
            {}
            {
                Scholarship holder and researcher in the academic workgroup
                PCM Computational Applications
            }

\cventry    {August 2013--\\current}
            {Web developing staff}
            {Fundaci\'on Alas de Cristal}
            {}
            {}
            {Developer and technology advaisor of the foundation}

\cventry    {July 2013--\\September 2013}
...
\cventry    {January 2013--\\September 2013}
...
\cventry    {October 2012--\\February 2013}
            {Student Assistant}
            {Universidad Nacional de Colombia}
            {}
            {}
