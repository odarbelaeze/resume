...
\cventry{March 2018}
        {Vegas: Paquete de software para la simulación atomística de materiales magneticos}
...
\cventry{Abr. 2016\\--actual}
        {Ingeniero de software full-stack}
        {BairesDev}
        {}
        {}
        {%
            Ofrezco servicios de ingeniería para contratistas de
            \href{https://www.adroll.com/}{AdRoll} through
            \href{http://www.bairesdev.com/}{BairesDev}. My responsibilities
            mis responsabilidades incluyen la escritura y el mantenimiento de código que permite a los anunciantes publicar
            sus campañas publicitarias nativas a través de AdRoll, tanto en el Backend como en el frontend
            frontend.
        }
...
\cventry{Feb. 2016\\--May. 2017}
        ...
        {}
        {%
            Ofrezco cursos persenciales para el departamento de ciencias exactas y naturales en la Universidad Nacional de Colombia
            Ofrecí Simulación 1 para ingeniería física en el primer semestre del 2016, e informatica 3 para ingeniería física en el 
            segundo semestre del 2016 y el primer semestre de 2017.
        }        
