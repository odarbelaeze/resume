...
\cventry    {Sept. 2014}
            {
                ...
                ferromagnetic/antiferromagnetic multilayers of
                manganites
            }
...
\cvcomputer
    {Programación}  {C/C++\\FORTRAN\\Java\\Python\\JavaScript\\PHP}
    {Automat.}      {Autotools\\distutils\\Unittest\\Gulp\\CMake}

\cvcomputer
    {Científico}    {Octave\\SciDavis\\GnuPlot\\scipy stack}
    {Typografía}    {\LaTeX{}\\\LyX{}}


\cvcomputer
    {Diseño~Web}    {HTML5\\CSS3}
